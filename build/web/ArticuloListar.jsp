<%-- 
    ...
    Created on : 09-jul-2021, 1:26:45
    Author     : sagit
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="col-sm-8 mx-auto my-5">
                <p class="text-center tituloF">Lista de Productos<p>
                ...
                <table class="table">
                    ...
                    <form action="PedidoControl" method="post">
                        ...
                        <td><input type="text" name="codCateg" size="5" value="<%= f[4]%>" /></td>
                        <td><input type="text" name="mar" size="5" value="<%= f[5]%>" /></td>
                        <td><input type="text" name="tal" size="5" value="<%= f[6]%>" /></td>
                        <td><input type="text" name="col" size="5" value="<%= f[7]%>" /></td>
